    ...
    <div class="container text-center">
        ...
        <div class="about">
            ...
            <div class="about-caption">
                ...
                <a target="_blank" href="{{ route('download.cv') }}" class="btn-rounded btn btn-outline-primary mt-4">Descargar CV</a>
                {{-- <button class="btn-rounded btn btn-outline-primary mt-4" onclick="{{ route('download.cv') }}"></button> --}}
            </div>
